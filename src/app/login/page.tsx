...
export default function Login() {
  return (
    <main className="pt-36 flex h-screen w-full flex-col items-center bg-gray-100 px-2 md:px-0">
      <h1 className="leading-[3.5rem] animate-bg-move mb-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-200 via-neutral-700 to-gray-200
       bg-clip-text text-center text-5xl md:text-6xl font-black text-transparent"
      >
        Next.js 14 TodoMVC
      </h1>
